...
This document defines the comprehensive cross-framework mapping for all 19 OPENCLAW skills across **MITRE ATT&CK v19**, **NIST CSF 2.0**, **MITRE D3FEND v1.4**, **MITRE ATLAS**, and **OWASP Standards**.
...
| **`telegram-hitl`** | Human-in-the-Loop | — | GV.PO-02, RS.CO-01 | — | — | Operator Governance |
...
│ TA0001 Initial  │ Phase 3 (webapp-testing, api-testing)     │ T1190, T1133, T1078       │
...
Every finding reported by OPENCLAW automatically proposes the corresponding **D3FEND Defensive Countermeasure ID** to the defensive / engineering team:
